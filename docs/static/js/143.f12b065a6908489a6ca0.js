...
/* harmony default export */ __webpack_exports__["default"] = ({
    ...
    components: {
        'c-author': function cAuthor(resolve) {
            return __webpack_require__.e(/*! AMD require */ 110).then(function() { var __WEBPACK_AMD_REQUIRE_ARRAY__ = [__webpack_require__(/*! @/ui/components/author */ "./src/ui/components/author/index.vue")]; (resolve).apply(null, __WEBPACK_AMD_REQUIRE_ARRAY__);}.bind(this)).catch(__webpack_require__.oe);
        },
        'c-rating-stars': function cRatingStars(resolve) {
            return __webpack_require__.e(/*! AMD require */ 94).then(function() { var __WEBPACK_AMD_REQUIRE_ARRAY__ = [__webpack_require__(/*! @/ui/components/rating-stars */ "./src/ui/components/rating-stars/index.vue")]; (resolve).apply(null, __WEBPACK_AMD_REQUIRE_ARRAY__);}.bind(this)).catch(__webpack_require__.oe);
        },
        'c-button': function cButton(resolve) {
            return __webpack_require__.e(/*! AMD require */ 144).then(function() { var __WEBPACK_AMD_REQUIRE_ARRAY__ = [__webpack_require__(/*! @/ui/components/buttons/wide */ "./src/ui/components/buttons/wide.vue")]; (resolve).apply(null, __WEBPACK_AMD_REQUIRE_ARRAY__);}.bind(this)).catch(__webpack_require__.oe);
        }
    },
    data: function data() {
        return {
...
//# sourceMappingURL=143.f12b065a6908489a6ca0.js.map