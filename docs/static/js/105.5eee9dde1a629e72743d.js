...
/* harmony default export */ __webpack_exports__["default"] = ({
    ...
    components: {
        'c-modal': function cModal(resolve) {
            return __webpack_require__.e(/*! AMD require */ 111).then(function() { var __WEBPACK_AMD_REQUIRE_ARRAY__ = [__webpack_require__(/*! @/ui/components/modal */ "./src/ui/components/modal/index.vue")]; (resolve).apply(null, __WEBPACK_AMD_REQUIRE_ARRAY__);}.bind(this)).catch(__webpack_require__.oe);
        },
        'c-images-explorer': function cImagesExplorer(resolve) {
            return __webpack_require__.e(/*! AMD require */ 112).then(function() { var __WEBPACK_AMD_REQUIRE_ARRAY__ = [__webpack_require__(/*! @/ui/components/images-explorer */ "./src/ui/components/images-explorer/index.vue")]; (resolve).apply(null, __WEBPACK_AMD_REQUIRE_ARRAY__);}.bind(this)).catch(__webpack_require__.oe);
        }
    },
    data: function data() {
        return {
...
//# sourceMappingURL=105.5eee9dde1a629e72743d.js.map