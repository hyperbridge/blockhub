...
/* harmony default export */ __webpack_exports__["default"] = ({
    ...
    components: {
        'c-pagination': function cPagination(resolve) {
            return __webpack_require__.e(/*! AMD require */ 92).then(function() { var __WEBPACK_AMD_REQUIRE_ARRAY__ = [__webpack_require__(/*! @/ui/components/pagination */ "./src/ui/components/pagination/index.vue")]; (resolve).apply(null, __WEBPACK_AMD_REQUIRE_ARRAY__);}.bind(this)).catch(__webpack_require__.oe);
        },
        'c-load-more': function cLoadMore(resolve) {
            return __webpack_require__.e(/*! AMD require */ 95).then(function() { var __WEBPACK_AMD_REQUIRE_ARRAY__ = [__webpack_require__(/*! @/ui/components/buttons/load-more */ "./src/ui/components/buttons/load-more.vue")]; (resolve).apply(null, __WEBPACK_AMD_REQUIRE_ARRAY__);}.bind(this)).catch(__webpack_require__.oe);
        }
    },
    computed: {
...
//# sourceMappingURL=89.3f99475286715f973a07.js.map