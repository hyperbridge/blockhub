...
/* harmony default export */ __webpack_exports__["default"] = ({
    ...
    components: {
        'c-dropdown-menu': function cDropdownMenu(resolve) {
            return __webpack_require__.e(/*! AMD require */ 101).then(function() { var __WEBPACK_AMD_REQUIRE_ARRAY__ = [__webpack_require__(/*! @/ui/components/dropdown-menu */ "./src/ui/components/dropdown-menu/index.vue")]; (resolve).apply(null, __WEBPACK_AMD_REQUIRE_ARRAY__);}.bind(this)).catch(__webpack_require__.oe);
        },
        'c-reply': function cReply(resolve) {
            return __webpack_require__.e(/*! AMD require */ 102).then(function() { var __WEBPACK_AMD_REQUIRE_ARRAY__ = [__webpack_require__(/*! @/ui/components/product-community/reply */ "./src/ui/components/product-community/reply.vue")]; (resolve).apply(null, __WEBPACK_AMD_REQUIRE_ARRAY__);}.bind(this)).catch(__webpack_require__.oe);
        },
...
//# sourceMappingURL=100.783253ef2bc8714352eb.js.map