...
/* harmony default export */ __webpack_exports__["default"] = ({
    ...
    components: {
        'c-modal': function cModal(resolve) {
            return __webpack_require__.e(/*! AMD require */ 121).then(function() { var __WEBPACK_AMD_REQUIRE_ARRAY__ = [__webpack_require__(/*! @/ui/components/modal */ "./src/ui/components/modal/index.vue")]; (resolve).apply(null, __WEBPACK_AMD_REQUIRE_ARRAY__);}.bind(this)).catch(__webpack_require__.oe);
        },
        'c-images-explorer': function cImagesExplorer(resolve) {
            return __webpack_require__.e(/*! AMD require */ 122).then(function() { var __WEBPACK_AMD_REQUIRE_ARRAY__ = [__webpack_require__(/*! @/ui/components/images-explorer */ "./src/ui/components/images-explorer/index.vue")]; (resolve).apply(null, __WEBPACK_AMD_REQUIRE_ARRAY__);}.bind(this)).catch(__webpack_require__.oe);
        }
    },
    data: function data() {
        return {
...
//# sourceMappingURL=115.7a38d91b008ab3646a2d.js.map