        ...
        <div class="container">
                ...
                <div class="col-sm-12">
                    <div class="heading-title" v-html="content">
                        <h3 class="title tw-5 mb-20">
                            <a href="#wallets">Hardware Wallets</a>
                        </h3>
                        {{ content }}
                    </div>
                </div>
            ...
            <div class="row">
                <div class="col-12 second-carousel">
                    <div
                        class="owl-carousel popup-gallery"
                        data-nav-dots="true"
                        data-nav-arrow="true"
                        data-items="2"
                        data-sm-items="2"
                        ...
                        <div v-for="(item, index) in items" :key="index" class="item">
                            <div class="clients-blog mtb-15">
                                ...
                                <ul class="list-inline">
                                    ...
                                    <li class="list-inline-item">
                                        <a :href="item.link">{{ item.domain }}</a>
                                    </li>
                                    <li class="list-inline-item list-item-go">
                                        <a class="button mt-25" :href="item.link">Go to {{ item.company }}</a>
                                    </li>
                                </ul>
                            </div>
                        </div>
