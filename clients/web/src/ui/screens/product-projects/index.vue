    ...
    <div class="row">
        <div class="col-12">
            <div class="filter d-flex justify-content-between">
                ...
                <div>
                    <c-button status="info" icon_hide href="#/project/new" v-if="developerMode">Propose Idea</c-button>
                    <c-button status="info" icon_hide @click="$store.commit('application/activateModal', 'propose-idea')" v-if="!developerMode">Propose Idea</c-button>
                </div>
            </div>
        </div>
