...
<script>
    ...
    export default {
        ...
        components: {
            'c-game-plan': (resolve) => require(['@/components/game-plans/plan'], resolve),
            'c-screen-gallery': (resolve) => require(['@/components/screen-gallery/gallery'], resolve),
            'c-promotion-box': (resolve) => require(['@/components/promotion-box/item'], resolve),
            'c-rating-block': (resolve) => require(['@/components/rating-block'], resolve),
            'c-purchase-block': (resolve) => require(['@/components/purchase-block'], resolve),
            'c-frequently-traded-assets': (resolve) => require(['@/components/frequently-traded-assets'], resolve),
            'c-community-spotlight': (resolve) => require(['@/components/community-spotlight'], resolve),
            'c-heading-bar': (resolve) => require(['@/components/heading-bar'], resolve),
            'c-review': (resolve) => require(['@/components/review'], resolve),
            'c-system-requirements': (resolve) => require(['@/components/product-overview/system-requirements'], resolve),
            'c-language-support': (resolve) => require(['@/components/product-overview/language-support'], resolve),
            'c-stream-item': (resolve) => require(['@/components/stream'], resolve),
            'c-modal': (resolve) => require(['@/components/modal'], resolve),
            'c-game-installer': (resolve) => require(['@/components/game-installer'], resolve),
            
              'c-review-form': (resolve) => require(['@/components/review/create'], resolve),
        },
        data() {
            return {
