...
<script>
    ...
    export default {
        ...
        components: {
            ...
            'c-participation-tier': (resolve) => require(['@/components/participation-tier'], resolve),
            ...
            'c-contribute-form': (resolve) => require(['@/components/contribute/form'], resolve),
            'c-contribute-pledge': (resolve) => require(['@/components/contribute/pledge'], resolve),
            'c-badges': (resolve) => require(['@/components/project/badges'], resolve),
            'c-decentralization-meter': (resolve) => require(['@/components/decentralization-meter'], resolve),
