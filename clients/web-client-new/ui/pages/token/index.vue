<template>
    <c-layout navigationKey="store">
            ...
            <div class="col-12 col-md-6">
                <c-block>
                    ...
                    <p>
                        ...
                        <br />
                        For the game developers, when accepting HBX you will receive a number of benefits, including reduced fees by 50%. To learn more, please see the <c-button status="underline" size="md" href="https://hyperbridge.org/whitepaper" target="_blank">White Paper</c-button>.
                        <br /><br />
                    </p>
                    <div class="carousel-wrapper margin-auto margin-top-20 margin-bottom-20" style="zoom: 0.7">
                        <c-carousel-3d
                    ...
                    <p>Purchasers will be rewarded the exclusive Voyager Badge and Master Sword (<a href="http://erc721.org/" target="_blank">ERC-721 NFTs</a>). These unique items will be some of the first items tradeable within our upcoming games &amp; marketplace.</p>
                </c-block>
            </div>
        </div>
        ...
        <div ref="purchase" class="row promotion margin-top-40 margin-bottom-20"></div>

        <div class="" v-if="!ethereumConnected" style="text-align: center; width: 100%" hidden>
            <c-welcome-box />
            <br /><br />
        </div>

        <div class="col-12" v-if="isMobile" style="text-align: center; width: 100%; margin-top: 30px; padding:20px;border: 3px dashed rgba(0,0,0,0.1); border-radius: 7px;background: rgba(0,0,0,0.2)">
        ...
        <div v-if="!isMobile">
            <div class="col-12 col-md-6 offset-md-3" v-if="!ethereumConnected" style="text-align: center; width: 100%">
                ...
                <a href="https://chrome.google.com/webstore/detail/metamask/nkbihfbeogaeaoehlefnkodbefgpgknn?hl=en" hidden>
            ...
            <div class="col-12" v-if="ethereumConnected && !ethereumUnlocked" hidden>
                <c-welcome-box />
            </div>

            <div class="col-6 offset-3" v-if="ethereumConnected && !ethereumUnlocked" style="text-align: center; width: 100%; margin-top: 30px; padding:20px;border: 3px dashed rgba(0,0,0,0.1); border-radius: 7px;background: rgba(0,0,0,0.2)">
                <h2 hidden>Purchase Tokens with MetaMask</h2>
            ...
            <div class="col-4 offset-4" v-if="ethereumConnected && ethereumUnlocked" style="text-align: center; width: 100%; margin-top: 30px; margin-bottom: 30px; padding:20px;border: 3px dashed rgba(0,0,0,0.1); border-radius: 7px;background: rgba(0,0,0,0.2); zoom: 0.8" hidden>
                <img src="/img/metamask-logo.png" style="max-width: 150px;margin: 0 auto;" />

                <br /><br />

                <h2 style="margin: 0">Connected to MetaMask <span class="fa fa-check-circle" /></h2>
            </div>

            <div class="row">
                <div class="col-12 col-md-6" v-if="ethereumConnected && ethereumUnlocked">
                ...
                <div class="col-12 col-md-6" v-if="ethereumConnected && ethereumUnlocked && desktopMode">
                    <c-block title="Payment" class="margin-bottom-30">
                        <div class="profile-picker">
                            <c-swiper :options="profileOptions">
                                <c-swiper-slide v-for="profile in profiles" :key="profile.id">
                                    <div
                ...
                <div class="col-8 offset-2" v-if="ethereumConnected && ethereumUnlocked && desktopMode && !account.isVerified && account.isVerifying" style="text-align: center">
                ...
                <div v-if="ethereumConnected && ethereumUnlocked && (!desktopMode || account.isVerified || override)" style="text-align: center">
                    <div class="col-10 offset-1 tab-card">
                        <h4>Purchase Agreement</h4>
                        <div class="termsBlock">
                            <p class="c21 c27"><span class="c5"></span></p><p class="c19 c21"><span class="c11">This Token Sale Agreement (the</span><span class="c13">&nbsp;“Agreement”</span><span class="c11">)</span><span class="c13">&nbsp;</span><span class="c6">is an agreement between </span></p><ol class="c7 lst-kix_list_14-0 start" start="1"><li class="c25"><span class="c6">you or the legal entity that you represent (</span><span class="c1">“Buyer”</span><span class="c6">) and </span></li><li class="c15"><span class="c1">Hyperbridge Technology Inc. OÜ </span><span class="c6">(<a href="https://www.teatmik.ee/en/personlegal/14476002-Hyperbridge-Technology-Inc.-O%C3%9C" target="_blank">registry code: 14476002</a>) registered under the laws of Estonia</span><span class="c1">&nbsp;</span><span class="c6">(</span><span class="c1">“Company”</span><span class="c6">).</span></li></ol><p class="c19"><span class="c11">Buyer and Company, individually herein referred to as a </span><span class="c13">“Party”</span><span class="c11">&nbsp;and collectively as the “</span><span class="c13">Parties</span><span class="c6">”, have agreed on the following:</span></p><ol class="c7 lst-kix_list_3-0 start" start="1"><li class="c0"><span class="c5">DEFINITIONS </span></li></ol><ol class="c7 lst-kix_list_3-1 start" start="1"><li class="c12"><span class="c6">The Agreement terms that are written in the upper case first letter hereinafter is used in the following meanings unless the context indicates a different meaning:</span></li></ol><ol class="c7 lst-kix_list_17-2 start" start="1"><li class="c4"><span class="c6">“</span><span class="c1">Account</span><span class="c6">” - a Participant’s account on the Website, which is created and used to purchase HBX tokens. Only Participants have a right to purchase HBX tokens on the terms provided herein.</span></li><li class="c4"><span class="c6">“</span><span class="c1">Agreement</span><span class="c6">” - these Terms and all other operating rules and procedures that may be published from time to time on the Website (including Privacy Policy).</span></li><li class="c4"><span class="c6">“</span><span class="c1">Blockchain</span><span class="c6">” - a distributed cryptography-powered database that maintains a list of records, chained together against revision and tampering.</span></li><li class="c4"><span class="c6">“</span><span class="c1">Crowdsale</span><span class="c6">”- funding process aimed at receiving contribution for the development and support of Hyperbridge Project. The Crowdsale phases are pre-ICO and ICO.</span></li><li class="c4"><span class="c6">“</span><span class="c1">Crowdsale</span><span class="c6">&nbsp;dashboard” - a panel on the Website where each Participant has access to information about his account and can control the process of funding his account, buying of tokens and other processes necessary to participate in the Crowdsale.</span></li><li class="c4"><span class="c6">“</span><span class="c1">Ethereum</span><span class="c6">” - an open-source, public, blockchain-based computing platform featuring smart contract functionality.</span></li><li class="c4"><span class="c6">“</span><span class="c1">KYC</span><span class="c6">” - know your customer (KYC) process of identifying and verifying the profile of the Participants.</span></li><li class="c4"><span class="c6">“</span><span class="c1">Loss</span><span class="c6">”- damages, claims, applications, loss, injuries, delays, accidents, costs, business interruption, expenses (including, without limitation, counsel’s or legal fees or the costs of any claim or suit), any incidental, direct, indirect, general, special, punitive, exemplary, special or consequential damages, any loss of goodwill, profits or revenue or any other economic loss, any loss of cryptocurrency or digital assets, any work stoppage, data loss, computer failure or malfunction, or any other commercial or other loss.</span></li><li class="c4"><span class="c6">“</span><span class="c1">Participant</span><span class="c6">” - user who has been registered, upon his request, for the HBX tokens purchasing.</span></li><li class="c4"><span class="c6">“</span><span class="c1">Terms</span><span class="c6">” - these Terms and Conditions.</span></li><li class="c4"><span class="c6">“</span><span class="c1">Website</span><span class="c6">” - HYPERBRIDGE website: </span><span class="c11 c22"><a class="c17" href="https://www.hyperbridge.org">https://www.hyperbridge.org</a></span><span class="c6">, the Crowdsale Dashboard, all subdomains and all their respective pages.</span></li><li class="c4" id="h.gjdgxs"><span class="c6">“</span><span class="c1">White</span><span class="c6">&nbsp;</span><span class="c1">Paper</span><span class="c6">” - the document describing HYPERBRIDGE Project available on the Website at </span><span class="c22 c11"><a class="c17" href="https://hyperbridge.org/whitepaper">https://hyperbridge.org/whitepaper</a></span><span class="c6">&nbsp;as may be amended from time to time.</span></li><li class="c4"><span class="c6">“</span><span class="c1">User</span><span class="c6">” - anyone who uses the Website, without prior registration and authorization using the Account.</span></li><li class="c4"><span class="c6">“</span><span class="c1">HYPERBRIDGE</span><span class="c6">&nbsp;</span><span class="c1">Project</span><span class="c6">” - software and infrastructure development for offering HYPERBRIDGE services and products as described in the White Paper.</span></li><li class="c4"><span class="c6">“</span><span class="c1">HBX</span><span class="c6">&nbsp;</span><span class="c1">Tokens</span><span class="c6">” or “</span><span class="c1">HBX</span><span class="c6">” - a coin based on ERC20 Ethereum token standard, which will allow its owner to participate in HYPERBRIDGE Project as further described in the White Paper and in the future use HBX for payment of services and products offered through HYPERBRIDGE platform, if and to the extent HYPERBRIDGE Project has been successfully completed and Launched.</span></li></ol><p class="c8 c18" id="h.30j0zll"><span class="c1"></span></p><p class="c3 c8 c24"><span class="c1"></span></p><ol class="c7 lst-kix_list_3-0" start="2"><li class="c2"><span class="c5">ENTERING INTO THE AGREEMENT AND TERMS OF USE. WHITE PAPER. LEGAL STATUS OF TOKENS </span></li></ol><ol class="c7 lst-kix_list_3-1 start" start="1"><li class="c0"><span class="c6">Buyer agrees to purchase, and Company agrees to sell the Tokens on the terms and conditions set forth in the Agreement. Buyer fully acknowledges, understands and agrees that it is subject to and bound by the Agreement by virtue of Buyer’s purchase of Tokens. The Agreement becomes effective and binding on Parties after Company has received the payment from Buyer. </span></li><li class="c0"><span class="c6">Company has the right to amend the White Paper at its sole discretion. Company shall publish a notice regarding the amendments through Hyperbridge communication channels and it is &#8203;Buyer's &#8203;responsibility &#8203;to &#8203;regularly &#8203;check &#8203;the &#8203; Hyperbridge communication channels &#8203;for &#8203;any &#8203;such &#8203;notices. In case of any conflicts between provisions of the White Paper and the Agreement, the Agreement shall prevail.</span></li><li class="c0"><span class="c6">HBX Tokens are a virtual currency-type crypto-tokens providing Buyer with a right to be used for all purchases as it is described in the White Paper and herein. </span></li><li class="c0 c8"><span class="c6">HBX Tokens may be tradable, however, Buyer may not be able to sell or otherwise transfer HBX Tokens due to potential lack of liquidity, including that Tokens may never become available for trade on secondary market (exchange).</span></li><li class="c0"><span class="c6">The Tokens are not a loan, legal tender currency, security, commodity, a swap on a currency or any other kind of financial instrument nor represent neither confer any ownership right or stake, share, or equivalent rights, or any right to receive future revenue, shares, dividends or participate in management, intellectual property rights or any other form of participation in Company. </span></li><li class="c0"><span class="c6">Buyer expressly agrees that purchases of the Tokens are non-refundable and cannot be cancelled or withdrawn. Buyer acknowledges the risk of losing any or all the Tokens.</span></li><li class="c0"><span class="c6">Company may decide to amend the intended functionality of the Tokens to ensure compliance with any legal or regulatory requirements the Tokens are subject to. Company may publish a notice of any changes to the functionality of the Tokens and it is &#8203;Buyer's &#8203;responsibility &#8203;to &#8203;regularly &#8203;check &#8203; Hyperbridge communication channels &#8203;for &#8203;any &#8203;such &#8203;notices. </span></li></ol><ol class="c7 lst-kix_list_3-0" start="3"><li class="c2"><span class="c5">TOKEN SALE PROCEDURE</span></li></ol><ol class="c7 lst-kix_list_3-1 start" start="1"><li class="c0"><span class="c6">The substantial information about the procedures and material specifications of the Token Sale are provided in the White Paper and on the https://www.hyperbridge.org, including details regarding the timing, pricing of the Token Sale, the number of Tokens purchased and the wallet address. By making the payment for the Tokens, Buyer acknowledges that Buyer has no objection to these procedures and material specifications.</span></li><li class="c0"><span class="c6">Buyer's purchase of the Tokens from Company during the Token Sale period is final, and there are no refunds or cancellations possible, except the refund of Buyer’s crypto funds in case the soft cap indicated on https://www.hyperbridge.org is not reached.</span></li><li class="c0"><span class="c6">Company reserves the right to establish the adequate refund procedure in case the previous exception takes place.</span></li><li class="c0"><span class="c6">Company reserves the right to reject the offers on acquisition of the Tokens at any time, at Company's sole discretion, including cases when the information provided by Buyer upon any requests is insufficient, inaccurate or misleading, or Buyer has not complied with any of the requirements &#8203;of Hyperbridge Platform.</span></li><li class="c0"><span class="c6">Company reserves the right to conduct a KYC (“Know Your Customer) and/or AML (“Anti-Money Laundering”) checks of Buyer &#8203;if &#8203;deemed &#8203;necessary &#8203;or &#8203;it &#8203;becomes &#8203;required &#8203;by &#8203;the &#8203;applicable &#8203;laws. Upon Company’s request, Buyer shall immediately provide to Company information and documents that Company, in its sole discretion, considers necessary or appropriate to conduct KYC and/or AML checks.</span></li><li class="c0"><span class="c6">At any time prior to the end of the Token Sale, Company may, at its own discretion, either temporarily suspend or permanently abort the Token Sale for security or any other reasons. Any suspension or abortion of Token Sale shall be deemed to commence from the moment that Company publishes a &#8203;notice &#8203;to &#8203;that &#8203;effect &#8203;on &#8203;the https://www.hyperbridge.org.</span></li></ol><ol class="c7 lst-kix_list_3-0" start="4"><li class="c2"><span class="c5">REPRESENTATIONS AND WARRANTIES OF BUYER </span></li></ol><p class="c19 c21"><span class="c6">Buyer represents and warrants, understands and agrees without any reservation that:</span></p><ol class="c7 lst-kix_list_9-1 start" start="1"><li class="c0 c8"><span class="c6">Buyer has all required powers and authority to execute, deliver, carry out and perform its obligations under the Agreement, including but not limited to making payments and purchase HBX Tokens within the process of Token Sale. </span></li><li class="c0 c8"><span class="c6">Buyer has read the Agreement and the White Paper carefully and in their entirety. Buyer shall not buy HBX Tokens, if any of the risks provided in the Agreement or in the White Paper are unacceptable.</span></li><li class="c0 c8"><span class="c6">Company does not have any obligation to recover any HBX Token. Purchases of HBX Tokens are non-refundable. Buyer may lose all paid amounts. </span></li><li class="c0 c8"><span class="c6">Buyer cannot hold any claims against Company for any losses or any special, incidental, or consequential damages arising from, or in any way connected to, the sale and purchase of HBX Tokens, including losses associated with the risks set forth in the Agreement.</span></li><li class="c0 c8"><span class="c6">Holding Tokens derived from the Token Sale carries no rights, express or implied, other than the right to use HBX Tokens to access the Network; to participate the Platform; to use the Token as means of payment; to use Token as a License framework; to tokenize in-game assets; to structure crowdfunding campaigns; to vote in polls and elect district leaders.</span></li><li class="c0 c8"><span class="c6">Tokens do not represent any ownership right, share or security or equivalent rights, or any right to receive future revenue, shares, dividends or participate in Company management. HBX Tokens do not grant its holder any intellectual property rights or any other form of participation in, or relating to, Company. HBX Tokens are not security, commodity or any other kind of financial instrument. </span></li><li class="c0"><span class="c6">Buyer has significant experience with, and understanding of, the usage and intricacies of cryptographic tokens, blockchain technology and smart contracts. Buyer has sufficient understanding of the functionality, usage, storage, transmission mechanisms and other material characteristics of cryptographic tokens, token storage mechanisms (such as token wallets), blockchain technology and blockchain-based software systems to understand the Agreement and to assess &#8203;the &#8203;risks &#8203;and &#8203;implications &#8203;of &#8203;purchasing &#8203;the &#8203;Tokens.</span></li><li class="c0 c8"><span class="c6">Company is not responsible for lost HBX Tokens or virtual currency resulting from actions taken by or omitted by Buyer. Buyer acknowledges and assumes the risks associated, including but not limited to: (i) loss of Buyer’s login data to Hyperbridge Platform account and loss of private keys of wallet storing HBX Tokens, (ii) incorrect functioning of Blockchain or Ethereum platform, (iii) cyberattacks and unanticipated regulatory changes by Governmental Authorities.</span></li><li class="c0 c8"><span class="c6">The blockchain used for the Token smart contracts which create the Tokens is susceptible to mining attacks, including double-spend attacks, majority mining power attacks, "selfish-mining" attacks, and race condition attacks. Any successful attacks present a risk to the token smart contract, expected proper execution and sequencing of the Token transactions, and expected proper execution and sequencing of contract computations;</span></li><li class="c0 c8"><span class="c6">Buyer is of sufficient legal age and capacity to purchase the Tokens. In case of a legal person, Buyer is duly organized, validly existing and in good standing under the laws of its domiciliary jurisdiction and each jurisdiction where it conducts business. &nbsp;</span></li><li class="c0 c8"><span class="c6">The Tokens will not be offered or distributed to, as well as they will not be resold or otherwise alienated by their holders to the following persons:</span></li></ol><ol class="c7 lst-kix_list_9-2 start" start="1"><li class="c10" id="h.1fob9te"><span class="c6">citizens of, natural and legal persons or persons acting on their behalf, having their habitual residence, location or their seat of incorporation in the United States of America, Puerto Rico, Northern Mariana Islands, Virgin Islands of the United States, American Samoa, or any other possessions of the United States of America; People’s Republic of China; South Korea and</span></li><li class="c10"><span class="c6">citizens of, natural and legal persons or persons acting on their behalf, having their habitual residence, location or their seat of incorporation in the country or territory where transactions with digital tokens are prohibited or in any manner restricted by applicable laws or regulations, or will become prohibited or restricted at any time after the Agreement becomes effective.</span></li></ol><ol class="c7 lst-kix_list_9-1" start="12"><li class="c0"><span class="c6">The entering into, and performance of, the Agreement will not result in any violation of, and be in conflict with, or constitute a material default under: </span></li></ol><ol class="c7 lst-kix_list_9-2 start" start="1"><li class="c0"><span class="c6">any &#8203;provision &#8203;of &#8203;Buyer’s corporation &#8203;documents;</span></li><li class="c0"><span class="c6">any provision of any judgment, decree or order to which Buyer is a party, by &#8203;which &#8203;it &#8203;is &#8203;bound, &#8203;or &#8203;to &#8203;which &#8203;any &#8203;of &#8203;its &#8203;material &#8203;assets &#8203;are &#8203;subject; </span></li><li class="c0"><span class="c6">any material agreement, obligation, duty or commitment to which Buyer is a &#8203;party &#8203;or &#8203;by &#8203;which &#8203;it &#8203;is &#8203;bound;</span></li><li class="c0"><span class="c6">any foreign exchange, anti-money laundering or regulatory restrictions applicable to&#8203; &#8203;Token Sale; &#8203;</span></li><li class="c0"><span class="c6">any &#8203;laws, &#8203;regulations &#8203;or &#8203;rules &#8203;applicable &#8203;to &#8203;Buyer.</span></li></ol><ol class="c7 lst-kix_list_9-1" start="13"><li class="c0"><span class="c6">Buyer undertakes to comply with any applicable tax obligations in Buyer's jurisdiction arising from &#8203;&#8203;the Token Sale.</span></li><li class="c0"><span class="c6">Buyer undertakes to comply with all applicable anti-money laundering and counter-terrorism financing &#8203;requirements. </span></li><li class="c0"><span class="c6">The execution and delivery of, and performance under, the Agreement require no approval or other action from any Governmental Authority or person other than Buyer.</span><span class="c1">&nbsp;</span></li><li class="c0"><span class="c6">There are no actions or investigations, pending or threatened before or by any Governmental Authority against Buyer which, if determined adversely, could reasonably be expected to have a material adverse effect on the ability of Buyer to enter into, and perform its obligations under, the Agreement. There is no unsatisfied judgment or any open injunction binding upon Buyer which could reasonably be expected to have a material adverse effect on the ability of Buyer to enter into, and perform its obligations under, the Agreement. If Buyer is a legal entity, Buyer makes the same representations with respect to its directors (or equivalent) and senior executive officers, and its affiliates.</span></li><li class="c0"><span class="c6">Signing up at Hyperbridge Platform and purchasing HBX Tokens, Buyer guarantees that she/he acknowledges and accepts all legal and other consequences related to Token purchase, including all potential risks, and releases the Company from any responsibility in case of such risks and damages.</span></li><li class="c0"><span class="c6">Buyer has obtained sufficient information about the Tokens to make an informed decision &#8203;to &#8203;purchase &#8203;the &#8203;Tokens.</span></li><li class="c0"><span class="c6">Buyer understands that the value of the Token over time may experience extreme volatility or depreciate in full.</span></li><li class="c0"><span class="c6">Buyer agrees and certifies that the Buyer is acquiring Tokens to be able to buy licenses that would qualify allow the token holder to be a professional proxy and not for investment or financial &#8203;purposes.</span><span class="c1">&nbsp;</span></li><li class="c0"><span class="c6">The funds, including any digital assets, fiat currency or virtual currency, that Buyer uses to purchase the Tokens, are not derived from or related to any unlawful activities, including but not limited to money laundering or terrorist financing, and Buyer will not use the Tokens to finance, engage in, or otherwise support &#8203;any &#8203;unlawful &#8203;activities.</span></li><li class="c0"><span class="c6">Buyer agrees that if Buyer’s country of residence or other circumstances change in such a way that any of the representations and warranties specified in the Agreement are no longer accurate, Buyer will &#8203;immediately &#8203;cease &#8203;using Hyperbridge Platform. </span></li></ol><p class="c3"><span class="c6"></span></p><ol class="c7 lst-kix_list_9-0 start" start="4"><li class="c12"><span class="c5">NO COMPANY'S REPRESENTATIONS AND WARRANTIES</span></li></ol><p class="c18"><span class="c9"></span></p><ol class="c7 lst-kix_list_9-1" start="23"><li class="c12"><span class="c6">Buyer expressly acknowledges, understands and agrees entirely and without any reservation that Buyer is purchasing the Tokens solely at Buyer’s own risk and that Tokens are provided, used and acquired on an “</span><span class="c11 c14">as is</span><span class="c6">” and on an “</span><span class="c14 c11">as available</span><span class="c6">” basis without representations, warranties, promises or guarantees whatsoever of any kind. Buyer’s decision to purchase the Tokens and enter into the Agreement shall be made based on Buyer’s own knowledge and information disclosed herein and in White Paper. Additionally, Buyer has conducted to its own satisfaction an independent investigation and verification of Hyperbridge Platform, HBX Tokens and shall therefore rely solely on its own examination. </span></li><li class="c12"><span class="c6">Company expressly disclaims all express and implied warranties and representations as to the Tokens, HBX Tokens and Hyperbridge Platform. Company &#8203;does not &#8203;make &#8203;any &#8203;representations &#8203;or &#8203;warranties, &#8203;express &#8203;or &#8203;implied, &#8203;including:</span></li></ol><ol class="c7 lst-kix_list_9-2 start" start="1"><li class="c12"><span class="c6">any &#8203;warranties &#8203;or &#8203;representations &#8203;of &#8203;title;</span></li><li class="c12"><span class="c6">any warranties or representations of merchantability or fitness for a particular purpose with respect to Hyperbridge Platform, the Tokens or their utility, or the ability of anyone &#8203;to &#8203;purchase &#8203;or &#8203;use the &#8203;&#8203;Tokens;</span></li><li class="c12"><span class="c6">the suitability, reliability, availability, timeliness, and accuracy of Hyperbridge Platform, the Tokens, information, software, products, services and related graphics on &#8203;the &#8203; Hyperbridge Platform &#8203;for &#8203;any &#8203;purpose. </span></li></ol><ol class="c7 lst-kix_list_9-0" start="5"><li class="c2"><span class="c5">LIMITATION OF LIABILITY</span></li></ol><ol class="c7 lst-kix_list_9-1 start" start="1"><li class="c0"><span class="c6">Company is not liable for any delay or failure to perform any obligation under the Agreement where the delay or failure results from any cause beyond Company's reasonable control.</span></li><li class="c0"><span class="c6">In no circumstances the aggregate joint liability of Company, whether in contract, warrant, tort or for damages of any kind under the Agreement will exceed the amount received by Company from Buyer.</span></li><li class="c0"><span class="c6">Company is not liable for any cryptocurrency exchange rate fluctuation. &nbsp;</span></li><li class="c0"><span class="c6">Except otherwise provided in the Agreement, Buyer will indemnify, defend, hold harmless and reimburse Company from and against any and all actions, proceedings, claims, damages, demands and actions (including, without limitation, fees and expenses of counsel), incurred by Company arising from or relating to:</span></li></ol><ol class="c7 lst-kix_list_4-0 start" start="1"><li class="c0"><span class="c6">Token Sale;</span></li><li class="c0"><span class="c6">use of the Tokens;</span></li><li class="c0"><span class="c6">Buyer’s responsibilities or obligations under the Agreement;</span></li><li class="c0"><span class="c6">Buyer’s breach of or violation of the Agreement;</span></li><li class="c0"><span class="c6">any inaccuracy in any representation or warranty of Buyer;</span></li><li class="c0"><span class="c6">Buyer’s violation of any rights of any other person or entity; and/or</span></li><li class="c0"><span class="c6">any act or omission of Buyer that is negligent, unlawful or constitutes wilful misconduct.</span></li></ol><ol class="c7 lst-kix_list_9-1 start" start="1"><li class="c0"><span class="c6">Company shall not be liable for the content, veracity and accuracy of the information published on the Company’s website in the advertising section. The information in the advertising section is not an offer, promise or warranty to the Buyer from the Company.</span></li><li class="c0"><span class="c6">Company reserves the right to exercise sole control over the defence, at Buyer’s expense, of any claim subject to indemnification under this Section. This indemnity is in addition to, and not in lieu of, any other indemnities set forth in a written agreement between Buyer and Company, including those provided under the Agreement.</span></li><li class="c0"><span class="c6">Company is not liable for the risks arising from lack of governance rights. Because HBX Tokens confer no governance rights of any kind with respect to the Company and the ownership of Hyperbridge Platform, all decisions involving Hyperbridge Platform or the Company itself will be made by the Company and the owner of Hyperbridge Platform at their sole discretion, including but not limited to, decisions to discontinue Hyperbridge Platform, to create and sell more HBX Tokens for use in Hyperbridge Platform, or to sell or liquidate the Company. These decisions could adversely affect Hyperbridge Platform and the utility of any HBX Tokens Buyer holds.</span></li><li class="c0"><span class="c6">Company is not liable for risks associated with lack of information. Buyers may not be able to obtain all information it would want regarding the Company, the HBX Tokens, Hyperbridge Platform, or the HBX Token ICO on a timely basis or at all. It is possible that Buyers may not be aware on a timely basis of material adverse changes that have occurred. Information may be highly technical by nature. As a result of these difficulties, as well as other uncertainties, Buyers may not have accurate or accessible information about Hyperbridge Platform. </span></li></ol><ol class="c7 lst-kix_list_9-0" start="6"><li class="c2"><span class="c5">Force Majeure</span></li></ol><ol class="c7 lst-kix_list_5-1 start" start="1"><li class="c0"><span class="c6">Buyer understands and agrees that Company shall not be liable in connection with any force majeure event, including, labour disputes or other industrial disturbances, electrical, telecommunications, hardware, software or other utility failures, software or smart contract bugs or weaknesses, earthquakes, storms, or other nature-related events, blockages, embargoes, riots, strikes, acts or orders of Government Authority, acts of terrorism or war, technological change, changes in interest rates or other monetary conditions, and, for the avoidance of doubt, changes to any blockchain-related protocol.</span></li><li class="c0"><span class="c6">If an event of force majeure occurs, the Party injured hereto by the other’s inability to perform may elect to suspend the Agreement, in whole or part, for the duration of the force majeure circumstances. &nbsp;</span></li></ol><p class="c20"><span class="c6"></span></p><p class="c28"><span class="c6"></span></p><ol class="c7 lst-kix_list_9-0" start="7"><li class="c2"><span class="c5">TAXES</span></li></ol><ol class="c7 lst-kix_list_8-1 start" start="1"><li class="c0"><span class="c6">Buyer must seek her/his own tax advice in connection with purchasing HBX Tokens, which may result in adverse tax consequences, including withholding taxes, income taxes, indirect taxes and tax reporting requirements. </span></li><li class="c0"><span class="c6">Buyer is responsible for withholding, collecting, reporting and remitting the correct taxes arising from the purchase, ownership, use, sale, transfer or liquidation of the Tokens to the appropriate tax authorities.</span></li><li class="c0"><span class="c6">Company bears no liability or responsibility with respect to any tax consequences to Buyer arising from the Token Sale.</span></li></ol><ol class="c7 lst-kix_list_8-0 start" start="8"><li class="c12 c8"><span class="c5">DATA AND PRIVACY</span></li></ol><p class="c18 c8"><span class="c5"></span></p><ol class="c7 lst-kix_list_8-1" start="4"><li class="c0"><span class="c6">Buyer shall implement reasonable and appropriate measures designed to secure access to: (i) any device associated with Buyer and utilized in connection with Buyer’s purchase of HBX Token and (ii) any other username, passwords or other login or identifying credentials. </span></li><li class="c0"><span class="c6">In the event Buyer is no longer in possession of Buyer’s private keys or any device associated with Buyer’s account or is not able to provide Buyer’s login or identifying credentials, Buyer may lose all purchased HBX Tokens and/or access to Buyer’s account. </span></li><li class="c0"><span class="c6">Buyer shall immediately provide to Company information and documents that Company, in its sole discretion, deems necessary or appropriate to comply with any laws, regulations, rules or agreements, including without limitation judicial process. Such documents include, but are not limited to, ID card, passport, driver’s license, utility bills, photographs of associated individuals, government identification cards, or sworn statements.</span></li><li class="c0"><span class="c6">Company may refuse to distribute HBX Tokens to Buyer until requested information is provided.</span></li><li class="c0"><span class="c6">Privacy and personal data clauses are provided in the Privacy Policy, which is an annex to this Agreement.</span></li></ol><ol class="c7 lst-kix_list_8-0" start="9"><li class="c2"><span class="c5">INTELLECTUAL PROPERTY RIGHTS</span></li></ol><ol class="c7 lst-kix_list_8-1 start" start="1"><li class="c0"><span class="c6">Hyperbridge has valid, unrestricted and exclusive ownership of rights to use the patents, trademarks, trademark registrations, trade names, copyrights, know-how, technology and other intellectual property necessary to the conduct the Crowdsale of the HBX and his activities generally.</span></li><li class="c0"><span class="c6">In no way shall this Agreement entitle the User or Participant for any intellectual property of Hyperbridge, including the intellectual property rights for the Website and all text, graphics, user interface, visual interface, photographs, trademarks, logos, artwork, and computer code, design, structure, selection, coordination, expression and other content connected to the Website. Arrangement of such content is owned by Hyperbridge and is protected by the Intellectual Property Rights and fair competition laws.</span></li></ol><ol class="c7 lst-kix_list_8-0" start="10"><li class="c2"><span class="c5">APPLICABLE LAW AND DISPUTE RESOLUTION</span></li></ol><ol class="c7 lst-kix_list_8-1 start" start="1"><li class="c0"><span class="c6">The Agreement has been drawn up in accordance with the laws of the Republic of Estonia and the application, interpretation, and termination thereof shall be subject to the laws of the Republic of Estonia. </span></li><li class="c0"><span class="c6">If any term, clause or provision of this Agreement is held unlawful, void or unenforceable, then that term, clause or provision will be severable from this Agreement and will not affect the validity or enforceability of any remaining part of that term, clause or provision, or any other term, clause or provision of this Agreement and the invalid condition shall be replaced by a valid condition as close as possible to the outcome and the detail of the replaced condition. </span></li><li class="c0"><span class="c6">Any Disputes arising from the performance of the Agreement shall be settled through negotiations. If the Parties fail to resolve the Dispute through negotiation, the Disputes shall be settled by Harju Maakohus (Harju County Court), pursuant to the procedure provided by the law of the Republic of Estonia.</span></li></ol><ol class="c7 lst-kix_list_8-0" start="11"><li class="c2"><span class="c5">TERMINATION OF AGREEMENT</span></li></ol><ol class="c7 lst-kix_list_8-1 start" start="1"><li class="c0"><span class="c6">Company`s obligations to transfer Tokens to Buyer under this Agreement shall terminate upon performance of the obligations of the parties in accordance with chapters 2 and 3 of the Agreement. Company may terminate this Agreement at its sole discretion, including without limitation, by reason of change in tax, securities, corporate or other law.</span></li><li class="c0"><span class="c6">Company may terminate the Agreement immediately without prior notice, if: &nbsp;</span></li></ol><ol class="c7 lst-kix_list_8-2 start" start="1"><li class="c0"><span class="c6">Buyer breaches this Agreement;</span></li><li class="c0"><span class="c6">Company is required so by valid court order, or binding order of a Governmental Authority; </span></li><li class="c0"><span class="c6">Buyer fails to comply with any applicable laws, directives, rules and/or regulations or Buyer is or becomes a person falling under Article 4.11 of the Agreement;</span></li><li class="c0"><span class="c6">in respect of Buyer, a liquidator, receiver or administrative receiver is appointed, Buyer is adjudicated as bankrupt, or declared insolvent. &nbsp;</span></li></ol><ol class="c7 lst-kix_list_11-1 start" start="3"><li class="c0"><span class="c6">Upon termination or expiration of this Agreement provisions related to limitation of Company's liability shall survive and apply, including, but not limited to, Articles 5 and 6 of this Agreement.</span></li><li class="c0"><span class="c6">Upon termination of this Agreement due to any reason Buyer’s rights shall terminate (including right to use Hyperbridge Platform and all rights associated with HBX Tokens) and the Buyer is not entitled to any refund.</span></li></ol><ol class="c7 lst-kix_list_8-0" start="12"><li class="c2"><span class="c5">MISCELLANEOUS</span></li></ol><ol class="c7 lst-kix_list_8-1 start" start="1"><li class="c0"><span class="c6">All agreements, notices, disclosures and other communications that the Party provides to the other Party pursuant to this Agreement or in connection with or related to Buyer’s purchase of HBX Token, including this Agreement, may be provided by the Party in electronic form.</span></li><li class="c0 c8"><span class="c6">The headlines of the subdivisions, articles or paragraphs contained in the Agreement are used for convenience and do not affect the meaning of the Agreement, or interpretation thereof. </span></li><li class="c0 c8"><span class="c6">Reference to a specific subdivision, article or paragraph of the Agreement is a reference to a specific subdivision, article or paragraph of the Agreement unless otherwise specified. &nbsp; &nbsp;</span></li></ol><p class="c30"><span class="c6"></span></p><div><p class="c23"><span class="c6"></span></p><p class="c16"><span class="c6"></span></p></div>
                        </div>
                            ...
                            <div class="tab-card" v-if="purchaseSuccessful">
                                <div class="row">
                                    <div class="col-12 mb-4 text-center">
                                        <h2><img src="/img/success.png" style="max-width: 100px;" /></h2>
                                        <p>
