...
<script>
    ...
    export default {
        ...
        components: {
            'c-product-overview': (resolve) => require(['@/pages/product-overview'], resolve),
            'c-product-projects': (resolve) => require(['@/pages/product-projects'], resolve),
            'c-product-assets': (resolve) => require(['@/pages/product-assets'], resolve),
            'c-product-community': (resolve) => require(['@/pages/product-community'], resolve),
