...
<script>
    ...
    export default {
        ...
        components: {
            ...
            'c-project-overview': () => import('~/pages/project-overview').then(m => m.default || m),
            'c-project-milestones': () => import('~/pages/project-milestones').then(m => m.default || m),
            'c-project-discussion': () => import('~/pages/project-discussion').then(m => m.default || m),
            'c-project-contributors': () => import('~/pages/project-contributors').then(m => m.default || m),
            'c-project-community': () => import('~/pages/project-community').then(m => m.default || m),
            'c-project-bounties': () => import('~/pages/project-bounties').then(m => m.default || m),
            'c-project-updates': () => import('~/pages/project-updates').then(m => m.default || m),
