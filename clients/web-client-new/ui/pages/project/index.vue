...
<script>
    ...
    export default {
        ...
        components: {
            ...
            'c-project-overview': (resolve) => require(['@/pages/project-overview'], resolve),
            'c-project-milestones': (resolve) => require(['@/pages/project-milestones'], resolve),
            'c-project-discussion': (resolve) => require(['@/pages/project-discussion'], resolve),
            'c-project-contributors': (resolve) => require(['@/pages/project-contributors'], resolve),
            'c-project-community': (resolve) => require(['@/pages/project-community'], resolve),
            'c-project-bounties': (resolve) => require(['@/pages/project-bounties'], resolve),
            'c-project-updates': (resolve) => require(['@/pages/project-updates'], resolve),
