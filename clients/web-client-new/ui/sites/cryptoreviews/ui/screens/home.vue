...
<script>
    ...
    export default {
        components: {
            ...
            'c-network-slider': (resolve) => require(['@/sites/cryptoreviews/ui/components/network-slider'], resolve),
            'c-history': (resolve) => require(['@/sites/cryptoreviews/ui/components/history'], resolve),
            'c-quick-links': (resolve) => require(['@/sites/cryptoreviews/ui/components/quick-links'], resolve),
            'c-notifications': (resolve) => require(['@/sites/cryptoreviews/ui/components/notifications'], resolve),
            'c-compare': (resolve) => require(['@/sites/cryptoreviews/ui/components/compare'], resolve),
            'c-media': (resolve) => require(['@/sites/cryptoreviews/ui/components/media'], resolve),
            'c-education': (resolve) => require(['@/sites/cryptoreviews/ui/components/education'], resolve),
            'c-exchanges': (resolve) => require(['@/sites/cryptoreviews/ui/components/exchanges'], resolve),
            'c-etoro-block': (resolve) => require(['@/sites/cryptoreviews/ui/components/etoro-block'], resolve),
            'c-market': (resolve) => require(['@/sites/cryptoreviews/ui/components/market'], resolve),
            'c-software-wallets': (resolve) => require(['@/sites/cryptoreviews/ui/components/software-wallets'], resolve),
            'c-hardware-wallets': (resolve) => require(['@/sites/cryptoreviews/ui/components/hardware-wallets'], resolve),
            'c-faq': (resolve) => require(['@/sites/cryptoreviews/ui/components/faq'], resolve),
        },
        data() {
