...
export default {
    ...
    components: {
        'c-button': (resolve) => require(['@/components/buttons/index.vue'], resolve),
        ...
        'c-product-cards': (resolve) => require(['@/components/store/product-cards'], resolve),
        'c-product-slider': (resolve) => require(['@/components/store/product-slider'], resolve),
        ...
        'c-assets-list-item': (resolve) => require(['@/components/assets-list-item/item'], resolve),
        'c-news-list-navigation': (resolve) => require(['@/components/news-list/navigation'], resolve),
        'c-news-list-articles': (resolve) => require(['@/components/news-list/articles'], resolve),
        'c-block': (resolve) => require(['@/components/block'], resolve),
        'c-simple-banner': (resolve) => require(['@/components/banner/simple'], resolve),
        'c-games-explorer': (resolve) => require(['@/components/store/games-explorer'], resolve),
        'c-assets-explorer': (resolve) => require(['@/components/store/assets-explorer'], resolve),
        ...
        'c-banner': (resolve) => require(['@/components/banner'], resolve),
        'c-game-series': (resolve) => require(['@/components/game-series'], resolve),
        'c-game-description': (resolve) => require(['@/components/game-series/game-description'], resolve),
        'c-game-includes-list': (resolve) => require(['@/components/game-series/game-includes-list'], resolve),
        'c-collection-list': (resolve) => require(['@/components/collection/list'], resolve),
        'c-collection-item': (resolve) => require(['@/components/collection/item'], resolve),
        'c-recommendation-block': (resolve) => require(['@/components/infinite-content/recommendation-block'], resolve),
    },
    data() {
        return {
