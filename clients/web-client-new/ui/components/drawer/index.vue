        ...
        <div id="fixed-panel"
            ...
            <div class="fixed-panel__content scroll">
                <template v-if="developerMode">
                    ...
                    <c-button v-for="(realm, index) in realms"
                              :key="`realm${realm.id}`"
                              v-darklaunch="'REALMS'"
                              status="none"
                              :to="`/realm/${realm.id}`">
                    ...
                    <c-button v-for="(product) in products"
                    ...
                    <c-button v-if="developerMode && products.length > 3"
                              status="none"
                    ...
                    <c-button v-darklaunch="'PAYMENTS'"
                              status="none"
                ...
                <div v-if="signedIn">
                    ...
                    <c-button v-darklaunch="'CONTACTS'"
                              status="plain"
                              tag="button"
