        ...
        <div class="fixed-panel invert" id="fixed-panel">
            <div class="fixed-panel__content scroll">
                <template v-if="developerMode">
                    ...
                    <c-button status="none" to="/profile/1/realms" v-darklaunch="'REALMS'">See More...</c-button>
                    ...
                    <c-button status="none" to="/business/realm/new" v-darklaunch="'REALMS'">
                        <span class="icon fa fa-plus"></span>
                        <span class="text">New Realm</span>
                    </c-button>
                    <c-button status="none" to="/business/product/new">
                        <span class="icon fa fa-plus"></span>
                        <span class="text">New Game</span>
                    </c-button>
                    <c-button status="none" to="/business/project/new">
                        <span class="icon fa fa-plus"></span>
                ...
                <div v-if="signedIn">
                    ...
                    <c-button status="plain" tag="button" to="/account/profiles" class="text-left" size="md" icon="id-card">
                        Profiles
                    </c-button>
                    <c-button status="plain" tag="button" to="/account/wallets" class="text-left" size="md" icon="credit-card" v-darklaunch="'WALLETS'">
                        Wallets
                    </c-button>
                ...
                <div class="developer-banner" v-if="!developerMode">
                    <div class="img">
                        <img
                ...
                <div class="preview-panel col-12 mt-4" v-if="showPreviewPanel">
                    <div>
                        ...
                        <c-button @click="rotateEnvironmentMode()">Environment Mode {{ environmentMode ? environmentMode.toUpperCase() : 'NOT FOUND' }}</c-button>
                        <c-button @click="toggleSignedIn()">Signed {{ signedIn ? 'IN' : 'OUT' }}</c-button>
