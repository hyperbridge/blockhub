    ...
    <header class="app-header">
        ...
        <div class="position-relative w-100"
            ...
            <div class="app-header__bar-left">
                <div v-if="desktopMode && operatingSystem === 'mac'"
                     class="mac-icons">
                ...
                <div v-if="desktopMode && operatingSystem === 'linux'"
                     class="linux-icons">
                    <c-button status="none"
                              class="close_w"
                              @click="closeWindow" />
                ...
                <div v-if="!desktopMode">
                    <router-link class="app-header__bar-left-link"
                                 to="/">
            ...
            <router-link class="app-header__bar-center"
                         :to="isLocked ? '#' : '/'">
            ...
            <div v-if="signedIn && developerMode"
                 class="app-header__options">
                <button v-if="!isViewing"
            ...
            <nav v-if="!signedIn || (signedIn && isViewing)"
                ...
                <nav class="horizontal-navigation app-header__nav-left">
                    ...
                    <ul>
                        ...
                        <li>
                            <c-dropdown class="ml-4 account-menu"
                                        style="z-index: 12"
                                        @show="onShowMenu"
                                        @hide="onHideMenu">
                                <template slot="title">
                ...
                <nav class="horizontal-navigation app-header__nav-right">
                    ...
                    <ul>
                        <li v-if="signedIn && developerMode && isViewing">
                            <button class="edit-btn btn btn-secondary btn-block btn--icon btn--icon-left"
                                    @click="clickEdit">
                        ...
                        <li v-if="!isLocked && languages"
                            v-darklaunch="'LANGUAGES'"
                            class="ml-3">
                            <c-language-dropdown :currentLanguage="currentLanguage"
                                                 :languages="languages"
                                                 @change="selectLanguages" />
                        </li>
                        <li v-if="!isLocked && currencies"
                            v-darklaunch="'CURRENCIES'"
                            class="ml-2">
                            <c-currency-dropdown :currentCurrency="currentCurrency"
