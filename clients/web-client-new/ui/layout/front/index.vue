...
<script>
    ...
    export default {
        ...
        mixins: [debouncer],
        components: {
            'c-header': (resolve) => require(['@/components/headers/basic'], resolve),
            'c-slim-header': (resolve) => require(['@/components/headers/slim'], resolve),
            ...
            'c-terms-popup': (resolve) => require(['@/components/terms-popup'], resolve),
            'c-privacy-popup': (resolve) => require(['@/components/privacy-popup'], resolve),
            'c-collection-navigation': (resolve) => require(['@/components/navigation/collection'], resolve),
            'c-wallet-navigation': (resolve) => require(['@/components/navigation/wallet'], resolve),
            'c-account-navigation': (resolve) => require(['@/components/navigation/account'], resolve),
            'c-settings-navigation': (resolve) => require(['@/components/navigation/settings'], resolve),
            'c-help-navigation': (resolve) => require(['@/components/navigation/help'], resolve),
            'c-funding-navigation': (resolve) => require(['@/components/navigation/funding'], resolve),
            'c-store-navigation': (resolve) => require(['@/components/navigation/store'], resolve),
            'c-asset-navigation': (resolve) => require(['@/components/navigation/asset'], resolve),
            'c-product-navigation': (resolve) => require(['@/components/navigation/product'], resolve),
            'c-project-navigation': (resolve) => require(['@/components/navigation/project'], resolve),
            'c-idea-navigation': (resolve) => require(['@/components/navigation/idea'], resolve),
            'c-welcome-popup': (resolve) => require(['@/components/welcome-popup/index.vue'], resolve),
            'c-download-popup': (resolve) => require(['@/components/download-popup/index.vue'], resolve),
            'c-unlock-popup': (resolve) => require(['@/components/unlock-popup/index.vue'], resolve),
            'c-claim-popup': (resolve) => require(['@/components/claim-popup/index.vue'], resolve),
            'c-login-popup': (resolve) => require(['@/components/login-popup/index.vue'], resolve),
            'c-register-popup': (resolve) => require(['@/components/register-popup/index.vue'], resolve),
            'c-send-funds-popup': (resolve) => require(['@/components/send-funds-popup/index.vue'], resolve),
            'c-purchase-popup': (resolve) => require(['@/components/purchase-popup/index.vue'], resolve),
            'c-mission-control-popup': (resolve) => require(['@/components/mission-control-popup/index.vue'], resolve),
            ...
            'c-clock': (resolve) => require(['@/components/clock/index.vue'], resolve),
            'c-status-dot': (resolve) => require(['@/components/status-dot/index.vue'], resolve),
            'c-sidepanel': (resolve) => require(['@/components/sidepanel'], resolve),
            'c-cookie-policy': (resolve) => require(['@/components/cookie-policy'], resolve),
            'c-qr-code': (resolve) => require(['@/components/qr-code'], resolve),
            'c-shortcut-sidebar': (resolve) => require(['@/components/shortcut-sidebar'], resolve),
            'c-load-more': (resolve) => require(['@/components/buttons/load-more.vue'], resolve),
            'c-render-condition': (resolve) => require(['@/components/render-condition'], resolve),
            'c-drawer': (resolve) => require(['@/components/drawer'], resolve),
            ...
            'c-social-connect': (resolve) => require(['@/components/social-connect'], resolve),
