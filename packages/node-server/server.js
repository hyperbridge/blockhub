...
function createRenderer (bundle, options) {
    ...
    return createBundleRenderer(bundle, Object.assign(options, {
        ...
        basedir: resolve('../../clients/web/dist'),
...
if (isProd) {
    ...
    const bundle = require('../../clients/web/dist/vue-ssr-server-bundle.json')
    // The client manifests are optional, but it allows the renderer
    // to automatically infer preload/prefetch links and directly add <script>
    // tags for any async chunks used during render, avoiding waterfall requests.
    //const clientManifest = require('../../clients/web/dist/vue-ssr-client-manifest.json')
...
app.use('/dist', serve('../../clients/web/dist', true))
app.use('/static', serve('../../clients/web/static', true))
