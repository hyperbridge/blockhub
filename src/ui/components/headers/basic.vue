...
<style lang="scss" scoped>
    ...
    .app-header__shadow {
        ...
        background: -moz-linear-gradient(top, rgb(29, 30, 47) 0%, rgba(48,49,77,0) 100%); /* FF3.6-15 */
        background: -webkit-linear-gradient(top, rgb(29, 30, 47) 0%,rgba(48,49,77,0) 100%); /* Chrome10-25,Safari5.1-6 */
