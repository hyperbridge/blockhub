<template>
    <header class="app-header">
        ...
        <div class="app-header__options" v-if="editor_mode">
            <button class="remove-btn btn btn-secondary btn-block btn--icon btn--icon-left" @click="clickRemove()">
...
export default {
    ...
    methods: {
        clickEdit() {
            this.$store.dispatch('marketplace/setEditorMode', true)
        },
        clickRemove() {
