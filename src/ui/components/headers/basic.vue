<template>
    <header class="appHeader">
        ...
        <div class="appHeader-options" v-if="developer_mode">
            ...
            <button class="publish-btn btn btn-secondary btn-block btn--icon btn--icon-left" @click="clickPublish()" v-if="developer_mode">
            ...
            <button class="exit-btn btn btn-secondary btn-block btn--icon btn--icon-left" @click="clickExit()" v-if="developer_mode">
        ...
        <nav class="appHeader-nav" v-if="!developer_mode">
            ...
            <nav class="horizontal-navigation appHeader-navRight">
                ...
                <ul>
                    <li>
                        <button class="edit-btn btn btn-secondary btn-block btn--icon btn--icon-left" @click="clickEdit()" v-if="!developer_mode">
...
export default {
    ...
    methods: {
        ...
        clickExit() {
            this.$store.dispatch('marketplace/setDeveloperMode', false)
        },
    }
}
</script>
