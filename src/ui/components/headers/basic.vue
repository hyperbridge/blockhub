<template>
    <header class="app-header">
        ...
        <div class="position-relative w-100" style="margin-top: -10px">
            ...
            <div class="app-header__options" v-if="signed_in && developer_enabled">
            ...
            <nav class="app-header__nav" v-if="!signed_in || (signed_in && developer_enabled && !is_editing)">
                ...
                <nav class="horizontal-navigation app-header__nav-right">
                    <button class="btn btn-light btn--icon" data-action="horizontal-show"><span class="fa fa-bars"></span> Toggle navigation</button>
                    <ul>
                        <li v-if="signed_in && developer_enabled && !is_editing">
...
<style lang="scss" scoped>
    ...
    .app-header__shadow {
        ...
        background: -moz-linear-gradient(top, rgba(48,49,77,1) 0%, rgba(48,49,77,0) 100%); /* FF3.6-15 */
        background: -webkit-linear-gradient(top, rgba(48,49,77,1) 0%,rgba(48,49,77,0) 100%); /* Chrome10-25,Safari5.1-6 */
        background: linear-gradient(to bottom, rgba(48,49,77,1) 0%,rgba(48,49,77,0) 100%); /* W3C, IE10+, FF16+, Chrome26+, Opera12+, Safari7+ */
        filter: progid:DXImageTransform.Microsoft.gradient( startColorstr='#e630314d', endColorstr='#0030314d',GradientType=0 ); /* IE6-9 */
        z-index: 11;
    }
