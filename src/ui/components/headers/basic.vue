<template>
    <header class="app-header">
        ...
        <div class="app-header__options">
            <button class="remove-btn btn btn-secondary btn-block btn--icon btn--icon-left" @click="clickRemove()" v-if="editor_mode">
            ...
            <button class="publish-btn btn btn-secondary btn-block btn--icon btn--icon-left" @click="clickPublish()" v-if="editor_mode">
            ...
            <button class="exit-btn btn btn-secondary btn-block btn--icon btn--icon-left" @click="clickExit()" v-if="editor_mode">
        ...
        <nav class="app-header__nav" v-if="!editor_mode">
            ...
            <nav class="horizontal-navigation app-header__nav-right">
                <button class="btn btn-light btn--icon" data-action="horizontal-show"><span class="fa fa-bars"></span> Toggle navigation</button>
                <ul>
                    <li v-if="signed_in && developer_enabled && !editor_mode">
