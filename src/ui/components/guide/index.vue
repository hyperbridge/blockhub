    ...
    <div class="container-fluid p-4">
        ...
        <c-block title="Buttons" class="margin-bottom-30">
            <div class="row justify-content-center">
                <div class="col-12 col-sm-6 col-md-4 col-lg-3 col-xl-2 buttons-container">
                    ...
                    <c-button size="md">default</c-button>
                    <c-button size="lg">default</c-button>
                </div>
                <div class="col-12 col-sm-6 col-md-4 col-lg-3 col-xl-2 buttons-container">
                ...
                <div class="col-12 col-sm-6 col-md-4 col-lg-3 col-xl-2 buttons-container">
                    <c-button status="warning">warning</c-button>
                    <c-button status="warning" size="md">warning</c-button>
                    <c-button status="warning" size="lg">warning</c-button>
                </div>
                <div class="col-12 col-sm-6 col-md-4 col-lg-3 col-xl-2 buttons-container">
                ...
                <div class="col-12 col-sm-6 col-md-4 col-lg-3 col-xl-2 buttons-container">
                    <c-button status="dark">dark</c-button>
                    <c-button status="dark" size="md">dark</c-button>
                    <c-button status="dark" size="lg">dark</c-button>
                </div>
                <div class="col-12 col-sm-6 col-md-4 col-lg-3 col-xl-2 buttons-container">
                    <c-button status="plain">plain</c-button>
                    <c-button status="plain" size="md">plain</c-button>
                    <c-button status="plain" size="lg">plain</c-button>
                </div>
            </div>
        </c-block>
        <c-block title="Outline Buttons" class="margin-bottom-30">
            <div class="row justify-content-center">
                ...
                <div class="col-12 col-sm-6 col-md-4 col-lg-3 col-xl-2 buttons-container">
                    <c-button status="outline-warning">warning</c-button>
                    <c-button status="outline-warning" size="md">warning</c-button>
                    <c-button status="outline-warning" size="lg">warning</c-button>
                </div>
                <div class="col-12 col-sm-6 col-md-4 col-lg-3 col-xl-2 buttons-container">
        ...
        <c-block title="Gradient Buttons" class="margin-bottom-30">
            <div class="row justify-content-center">
                ...
                <div class="col-12 col-sm-6 col-md-4 col-lg-3 col-xl-2 buttons-container">
                    <c-button status="gradient-warning">warning</c-button>
                    <c-button status="gradient-warning" size="md">warning</c-button>
                    <c-button status="gradient-warning" size="lg">warning</c-button>
                </div>
            </div>
        </c-block>
        <!--Buttons block end-->
                ...
                <div class="col-12">
                    <table class="table table-borderless">
                        <thead>
                            <tr>
                                <th>Type</th>
                                <th width="100">Font</th>
                                <th width="100">Size</th>
                                <th width="100">Color(Default)</th>
                            </tr>
                        </thead>
                        <tbody>
                            <tr>
