...
export default {
    components: {
        ...
        'c-button': (resolve) => require(['@/ui/components/buttons/index.vue']),
        ...
        'c-product-card': (resolve) => require(['@/ui/components/store/product-card']),
        'c-product-card-dynamic': (resolve) => require(['@/ui/components/store/product-card-dynamic']),
        'c-products-cards': (resolve) => require(['@/ui/components/store/products-cards']),
        'c-curators-reviews': (resolve) => require(['@/ui/components/store/curators-reviews']),
        'c-game-grid': (resolve) => require(['@/ui/components/games-grid/with-description']),
        'c-dropdown': (resolve) => require(['@/ui/components/dropdown-menu/type-2']),
        'c-searcher': (resolve) => require(['@/ui/components/searcher']),
        'c-content-navigation': (resolve) => require(['@/ui/components/content-navigation']),
        'c-assets-list-item': (resolve) => require(['@/ui/components/assets-list-item/item']),
        ...
        'c-banner': (resolve) => require(['@/ui/components/banner/simple']),
        'c-swiper': swiper,
        'c-slide': swiperSlide
    },
    data() {
