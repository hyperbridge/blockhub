                        ...
                        <div class="row">
                            ...
                            <div class="col-5">
                                        ...
                                        <ul class="rating-blk__list">
                                            <li v-for="(item, index) in rating_blk" :key="index">
                                                ...
                                                <span class="rating-blk__stars">
                                                    ...
                                                    <i class="fas fa-star-half" v-if="Number.isInteger(item.number) === false"></i>
                                                </span>
                                            </li>
                                        </ul>
                                ...
                                <div class="card invert traded-assets">
                                    <div class="card-body">
                                        ...
                                        <div class="traded-assets__filter">
                                            <div class="dropdown">
                                                <a class="btn btn-secondary dropdown-toggle" href="#" role="button" id="mostMenuLink" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                                    Most valuable
                                                </a>
                                            ...
                                            <div class="dropdown">
                                                <a class="btn btn-secondary dropdown-toggle" href="#" role="button" id="rarityMenuLink" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                                    Rarity
                                                </a>
                                                <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                                    <a class="dropdown-item" href="#">Action</a>
                                ...
                                <div class="card invert system-requirements">
                                    <div class="card-body">
                                        <h2 class="title">System Requirements <i class="fas fa-laptop title-icon"></i></h2>
