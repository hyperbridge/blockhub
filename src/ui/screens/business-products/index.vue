                        ...
                        <div class="widget">
                            ...
                            <div class="widget__container">
                                ...
                                <div class="widget__box widget__box--left">
                                    <div class="widget__informer">{{ products.length }} products</div>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-row">
                            ...
                            <div class="col-6 col-lg-2 d-none d-md-block">
                                <c-button href="#/business/product/new" status="dark" icon="plus" size="mg" class="w-100 justify-content-center h-100">
                                    New Product
                                </c-button>
                            </div>
                        </div>
                        ...
                        <div class="table-responsive margin-top-20 margin-bottom-0">
                            <table class="table table-striped table-bordered margin-bottom-0" style="min-width: 800px;">
                                ...
                                <tr v-for="product in products" :key="product.id">
                                    ...
                                    <td>
                                        <button class="btn btn-outline-success btn-block btn-sm">{{ product.status }}</button>
                                    </td>
                                    <td>
...
<script>
    export default {
        ...
        computed: {
            products() { return this.$store.state.marketplace.products }
        },
        mounted() {
            this.$nextTick(() => {
