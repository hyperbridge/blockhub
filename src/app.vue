    ...
    <div id="app" :class="{ 'disable-animations': !disableAnimations }">
        ...
        <div class="fixed-panel invert" id="fixed_panel">
            <div class="fixed-panel__content scroll">
                <h5 v-if="is_developer" v-darklaunch="'REALMS'">Your Realms</h5>

                <a href="/#/realm/1" v-if="is_developer" v-darklaunch="'REALMS'">
                ...
                <a href="/#/profile/1/realms" v-if="is_developer" v-darklaunch="'REALMS'">See More...</a>

                <hr v-if="is_developer" v-darklaunch="'REALMS'" />

                <h5 v-if="is_developer">Your Products</h5>
                <a v-if="is_developer" href="/#/product/1">
                ...
                <a v-if="is_developer" href="/#/profile/1/realms">See More...</a>

                <hr v-if="is_developer" />

                <a href="/#/developer" v-if="is_developer">
                    <span class="icon fa fa-wrench"></span>
                    <span class="text">Developer Area</span>
                </a>
                <a href="/#/realm/new" v-if="is_developer" v-darklaunch="'REALMS'">
                    <span class="icon fa fa-plus"></span>
                    <span class="text">New Realm</span>
                </a>
                <a href="/#/product/new" v-if="is_developer">
                    <span class="icon fa fa-plus"></span>
                    <span class="text">New Product</span>
                </a>
                <a href="/#/project/new" v-if="is_developer">
                    <span class="icon fa fa-plus"></span>
                ...
                <div class="d-flex justify-content-start">
                    <div class="dev_blk become_dev active" v-if="!is_developer">
                    ...
                    <div class="dev_blk is_dev" v-if="is_developer">
                        <h5><i class="fas fa-code"></i>Developer</h5>
                        <ul>
                            <li>
                                <a href="/#/developer/content">
                                    <i class="fas fa-list-alt"></i>
                                    My Content
                                </a>
                            </li>
                            <li>
                                <a href="/#/developer/payment">
                                    <i class="fas fa-info-circle"></i>
                                    Payment Settings
                                </a>
                            </li>
                            <li>
                                <a href="/#/developer/inquiries">
